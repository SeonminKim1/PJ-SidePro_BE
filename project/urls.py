...
urlpatterns = [
    ...
    path('<int:project_id>/comment/', views.CommentAPIView.as_view(), name='comment_view'),
    path('<int:project_id>/comment/<int:comment_id>/', views.CommentModifyAPIView.as_view(), name="comment_modify_view"),
]